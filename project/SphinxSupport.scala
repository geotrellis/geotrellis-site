...
object SphinxSupport {
  ...
  val sphinxScript = 
    SettingKey[Option[File]]("sphinx-script", "The location of the sphinx-build script")
  val sphinxCompile = 
    TaskKey[Seq[File]]("sphinx-compile", "Compile Sphinx documentation into /site resources")
  val generateDirectivesMapTarget = 
    SettingKey[File]("generate-directives-map-file")
  val generateDirectivesMap = 
    TaskKey[Seq[File]]("generate-directives-map", "Try to infer directives from source files")
